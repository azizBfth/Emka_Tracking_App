...
class _LoginFormValidationState extends State<LoginFormValidation> {
  ...
  final String _emkaWebSiteUrl = 'https://emkatech.tn/';
                ...
                child: Column(
                  children: [
                   ...
                   /* Container(
                        ...
                        child: Image.asset('assets/images/trackAssets.png')
                        )*/,
                    Expanded(
                      child: Container(
                          width: double.infinity,
                          ...
                          child: SingleChildScrollView(
                            child: Form(
                              autovalidate:
                                  true, //check for validation while typing
                              key: formkey,
                              child: Column(
...
*/
  ...
  openFacebook() async {
    ...
    if (Platform.isIOS) {
      fbProtocolUrl = 'fb://profile/100832921592051';
    } else {
      fbProtocolUrl = 'fb://page/100832921592051';
    }

    String fallbackUrl = 'https://www.facebook.com/Emka-100832921592051';
